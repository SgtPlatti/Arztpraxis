      ...
      //Verarbeitung
        while (input != 9) {
          ...
          //Eingabe ins Hauptmenü
            do {
                try {
                    input = Integer.parseInt(reader.readLine()); valid = true;
                } catch(Exception e) {
            ...
            switch(input) {
                ...
                case 5: System.out.println("Bitte Eingabe wiederholen");
                        break;

                case 6: System.out.println("Bitte Eingabe wiederholen");
                        break;

                case 7: System.out.println(String.format("Patienten aufrufen:\n%s", namen[0]));
                ...
                case 8: System.out.println("Bitte Eingabe wiederholen");
                        break;
